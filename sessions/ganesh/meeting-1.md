...
- Outside discussion
  - About hacking:
    - Most of the time it is via social engineering
      - co-ordinated efforts
      - indirectly via friends and family
    - Secret agencies
    - Dark web
    - Those we see in the films are mostly targeted towards non-computer literacy people
    - Rarely with long-term effort some group hack big governments and leak info
- Homework:
  - Install Ubuntu
